...
- Real-time chat with OpenAI Completions API-compatible model.
...
The AI chat widget is automatically included in the Telebrain build when you compile the project. The module includes:
...
- **Model**: Uses the model specified in Telebrain's settings (`aiChatModel`)
