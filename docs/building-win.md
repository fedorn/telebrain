...
Open **x86 Native Tools Command Prompt for VS 2022.bat**, go to ***BuildPath*** and run
    ...
    telebrain\Telegram\build\prepare\win.bat

## Build the project

Go to ***BuildPath*\\telebrain\\Telegram** and run (using [your **api_id** and **api_hash**](#obtain-your-api-credentials))
...
* The result Telebrain.exe will be located in **D:\TBBuild\telebrain\out\Debug** (and **Release**)
